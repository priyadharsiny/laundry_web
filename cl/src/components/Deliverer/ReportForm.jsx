	...
	return (
		<div className="w-5/5">
			<form onSubmit={handleSubmit}>
				<div className="flex">
					<label className="text-gray-500 w-2/6 font-semibold mr-24 float-right mt-4">
						Enter location :
					</label>

					<LocationInput
						setAddress={setAddress}
						className="float-left w-7/12 mt-2 mb-6 px-4 py-2 border-2 rounded-lg border-blue-500 text-gray-700 focus:outline-none focus:border-blue-500"
					/>
				</div>
