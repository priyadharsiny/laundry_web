...
const AdminNewPackage = () => {
	...
	const savePackage = async (e) => {
		...
		try {
			...
			setTimeout(() => navigate("/auth/admin/packages"), 2000);
		} catch (err) {
				...
				<div className="w-full pt-5 flex justify-center items-center">
					<div className="px-16 flex justify-center w-full">
						...
						>
							...
							<button
								type="submit"
								className="flex justify-center items-center w-full py-4 px-2 rounded-full bg-light-blue text-white font-semibold text-lg"
